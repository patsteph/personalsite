// pages/admin/signals-fixed.tsx
// This is a fixed version of the signals admin page that uses relative URLs
...
export default function SignalsAdminPage({ signals: initialSignals, error: serverError }: SignalsAdminPageProps) {
  ...
  useEffect(() => {
    // Show redirect message on the original page
    if (router.pathname === "/admin/signals") {
      router.push("/admin/signals-fixed");
    }
  }, [router]);
      ...
      <Layout section="admin">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-steel-blue">Manage Signals (Fixed API Version)</h1>
