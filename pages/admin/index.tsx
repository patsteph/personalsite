        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                <h2 className="text-xl font-bold text-emerald-600 mb-2">Site Content Editor</h2>
                <p className="text-gray-600 mb-4">Edit content for all pages of your website.</p>
                <button 
                  onClick={() => navigateTo('/admin/site-editor')}
