  ...
  return (
    <aside className="bg-linen p-6 md:sticky md:top-0 md:h-screen md:overflow-y-auto flex flex-col theme-transition">
      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <button
          onClick={toggleTheme}
          className="flex items-center justify-center p-2 rounded-full bg-steel-blue bg-opacity-10 hover:bg-opacity-20 transition-all duration-200"
          aria-label={theme === 'light' ? 'Switch to dark mode' : 'Switch to light mode'}
        >
          {theme === 'light' ? (
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16" className="text-steel-blue">
              <path d="M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278z"/>
            </svg>
          ) : (
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16" className="text-dark-text">
        ...
        <div className="social-icons flex justify-center space-x-4">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
              <text x="4" y="13" fontSize="14" fontWeight="bold">B</text>
            </svg>
          </a>
        </div>
      </div>
